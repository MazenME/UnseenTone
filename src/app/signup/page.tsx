    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-bg">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-fg-muted mt-2">Create your account and enter the dark</p>
        </div>
        ...
        <div className="bg-surface border border-border rounded-xl p-8 shadow-lg">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-surface px-3 text-fg-muted">or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            <div>
              <label htmlFor="displayName" className="block text-sm font-medium text-fg-muted mb-1.5">
                Display Name
              </label>
              <input
                id="displayName"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-fg-muted mb-1.5">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
